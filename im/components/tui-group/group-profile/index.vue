    ...
    <view>
        <view class="group-information-box" @show="getgroupProfile">
            <view class="group-box">
                <text class="group-ID"
                    >转诊状态：{{
                        referralInfo.referral_status_data_text
                    }}</text
                >
                <view @tap="showMoreHandler">
                    ...
                    <image
                        v-if="notShow"
                        class="icon-right"
                        src="https://jw-uniapp.oss-cn-beijing.aliyuncs.com/static/assets/down.svg"
                    ></image>
                    <image
                        v-if="isShow"
                        class="icon-right"
                        src="https://jw-uniapp.oss-cn-beijing.aliyuncs.com/static/assets/up.svg"
                    ></image>
                </view>
            </view>
            <view v-show="!hidden" class="showdetail">
                ...
                <view class="box" v-if="showMore">
                    <image
                        class="profile-box"
                        src="https://jw-uniapp.oss-cn-beijing.aliyuncs.com/static/assets/show.svg"
                        @tap="showMoreMember"
                    ></image>
                ...
                <view class="left-box">
                    <view class="box-group">
                        <image
                            class="addmember"
                            src="https://jw-uniapp.oss-cn-beijing.aliyuncs.com/static/assets/addgroup.svg"
                            @tap="toPage()"
                        ></image>
                        <text class="addmember-text">群设置</text>
                    </view>
                    <view class="box-group-quit">
                        <image
                            class="quitgroup"
                            src="https://jw-uniapp.oss-cn-beijing.aliyuncs.com/static/assets/quitgroup.svg"
                            @tap.stop="quitGroup"
                        ></image>
